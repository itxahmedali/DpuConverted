          ...
          <div class="d-flex justify-content-center text-left">
            <span class="p-1 wow bounceInLeft" data-wow-delay="0.5s" data-wow-duration="1.5s">
              ...
              <p class="pt-3 wow bounceInLeft" data-wow-delay="1s" data-wow-duration="1.5s">
                ...
                efficiently with their employees as it stores vast volumes of
          ...
          <div class="d-flex justify-content-center text-left pb-4">
            <span class="p-1 wow bounceInUp" data-wow-delay="0.5s" data-wow-duration="1.5s">
              <p>
                ...
                systems. The choices are very diverse when it comes to getting a
                web app developed for your business.
              </p>
            </span>
          </div>
        </div>
          ...
          <div class="row">
            <div class="col-lg-6 wow bounceInLeft" data-wow-delay="0.5s" data-wow-duration="1.5s">
              ...
              <div class="d-flex justify-content-center text-left pb-4">
                <span class="p-1">
                  <p>
                    At Design Pros USA, we don't just build your application -
                    we grow it from the ground up. We collaborate with you to
                    analyze and define what is needed for success in order to
                    create a fully functional web app that is robust as well as
                    scalable.
                  </p>
                </span>
              </div>
          ...
          <div class="box2">
            <div class="content-2 position-relative ">
              <div class="pb-4 pt-5">
                ...
                <span class="p-1 position-absolute ph3">
                  <p>
                    STEVEN
                  </p>
                </span>
